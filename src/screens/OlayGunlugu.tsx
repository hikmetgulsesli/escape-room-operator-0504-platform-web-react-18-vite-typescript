    ...
    <>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm md:hidden" onClick={() => setMobileMenuOpen(false)}>
          <nav className="absolute left-0 top-0 h-full w-64 bg-slate-900/95 backdrop-blur-lg border-r border-slate-800 shadow-2xl flex flex-col pt-16 pb-6 px-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex-1 flex flex-col gap-2 w-full">
              ...
              <button onClick={() => { onNavigate("logs"); setMobileMenuOpen(false); }} className="flex items-center gap-3 px-4 py-3 rounded bg-blue-600/30 text-white border-r-2 border-blue-500 font-inter text-xs font-medium uppercase tracking-widest transition-colors text-left"><span className="material-symbols-outlined text-[20px] filled">list_alt</span>Olay Günlüğü</button>
      ...
      <nav className="hidden md:flex flex-col h-full pt-16 pb-6 px-4 fixed left-0 top-0 w-64 border-r border-slate-800 shadow-2xl bg-slate-900/90 backdrop-blur-lg z-[60] transition-all duration-200 ease-in-out">
        ...
        <div className="flex-1 flex flex-col gap-2 w-full">
          ...
          <button onClick={() => onNavigate("logs")} className="flex items-center gap-3 px-4 py-3 rounded bg-blue-600/30 text-white border-r-2 border-blue-500 font-inter text-xs font-medium uppercase tracking-widest transition-colors text-left"><span className="material-symbols-outlined text-[20px] filled">list_alt</span><span>Olay Günlüğü</span></button>
