...
export function SistemAyarlari(props: SistemAyarlariProps) {
  return (
    <>
      ...
      <h1 className="text-xl font-bold text-slate-100 mb-1">Alpha Sector</h1>
      <p className="text-slate-400 text-[10px]">Lead Operator</p>
      </div>
      <div className="flex-1 space-y-2">
      <a className="flex items-center space-x-3 px-4 py-3 rounded text-slate-500 hover:text-slate-300 hover:bg-slate-800/40 transition-all" href="#">
      ...
      <a className="flex items-center space-x-3 px-4 py-3 rounded bg-blue-600/10 text-blue-400 border-r-2 border-blue-500 hover:bg-slate-800/40 transition-all" href="#">
      <span className="material-symbols-outlined text-lg" style={{fontVariationSettings: "'FILL' 1"}}>settings_input_component</span>
      <span>System Settings</span>
      </a>
      </div>
      <div className="mt-auto space-y-2">
      <button className="w-full py-2 bg-blue-600 hover:bg-blue-500 text-white rounded font-bold tracking-widest text-xs transition-colors mb-4 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                      NEW SESSION
                  </button>
      <a className="flex items-center space-x-3 px-4 py-3 rounded text-slate-500 hover:text-slate-300 hover:bg-slate-800/40 transition-all" href="#">
      ...
      <button className="p-2 text-slate-400 hover:text-blue-400 hover:bg-slate-800/50 rounded-full transition-colors relative">
      ...
      <button className="bg-error text-on-error font-label-caps px-4 py-1.5 rounded flex items-center space-x-1 hover:bg-red-400 transition-colors animate-pulse shadow-[0_0_10px_rgba(239,68,68,0.5)]">
      <span className="material-symbols-outlined text-sm">warning</span>
      <span>EMERGENCY STOP</span>
      </button>
      <img alt="Operator Profile" className="w-8 h-8 rounded-full border border-slate-700" data-alt="A close-up, high-contrast portrait of a male system operator in a dark, tech-focused environment. The lighting is moody, with sharp blue and subtle red reflections hinting at glowing screens off-camera. The aesthetic aligns perfectly with a mission-critical, cyber-command center UI, emphasizing professionalism and alertness." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCY6ZM0cKIXJ8pEwsyAiMN76PC_GmBIhCAUvZ2jvALBsRb7KH7m3GxIV7xXE1piPZJcZct59rsqEHK9FwEE6k6dNX4-Vy7ROLxBNgAU51WdTWQBNF_oufU3zYRpK7a2OQ9qeAp8WMp8_9a38xdDLITVUjgE1J7nYHA7hkrhZd_ey4B8K3o7GgxNhs1nyXOSwnIquvLateFbzccGqzl3kiab25UqsDrxoagqAK8XgM0ovp7guGOG8z4yrsxzgMc2UyvBxteSVTJIbq0" />
      </div>
      </header>
      {/* Main Canvas */}
      ...
      <input checked={true} className="sr-only peer" disabled={true} type="checkbox" value="" />
      ...
      <input className="w-full bg-surface-dim border border-outline-variant text-on-surface font-body-base text-body-base rounded-lg px-4 py-2 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all shadow-inner" type="text" value="Alpha Command 01" />
      </div>
      <div className="space-y-2">
      <label className="font-label-caps text-label-caps text-on-surface-variant">ERİŞİM SEVİYESİ</label>
      <input className="w-full bg-surface-container-lowest border border-outline-variant/50 text-on-surface-variant font-mono-data text-mono-data rounded-lg px-4 py-2 cursor-not-allowed" disabled={true} type="text" value="Level 4 - Lead Operator" />
      </div>
      ...
      <input className="w-full bg-surface-dim border border-outline-variant text-on-surface font-mono-data text-mono-data rounded-lg pl-10 pr-4 py-2 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="••••••••" type="password" />
      </div>
      </div>
      </div>
      <div className="p-md bg-surface-container-low border-t border-outline-variant/50 flex justify-end">
      <button className="bg-primary text-on-primary font-body-base text-body-base font-semibold px-6 py-2 rounded-lg hover:bg-primary-fixed transition-colors shadow-[0_0_15px_rgba(173,198,255,0.15)] flex items-center space-x-2">
      ...
      <button className="w-full bg-transparent border border-outline-variant text-on-surface hover:border-outline hover:bg-surface-container-highest font-body-base text-body-sm py-2 rounded transition-colors">
      ...
      <button className="w-full flex items-center justify-center space-x-2 bg-surface-variant hover:bg-surface-bright text-on-surface font-body-base text-body-base py-3 rounded-lg transition-colors border border-outline-variant">
      <span className="material-symbols-outlined text-sm">download</span>
      <span>Veriyi Dışa Aktar (Export)</span>
      </button>
      <button className="w-full flex items-center justify-center space-x-2 bg-transparent border border-dashed border-outline text-on-surface-variant hover:text-on-surface hover:border-primary font-body-base text-body-base py-3 rounded-lg transition-colors">
      ...
      <button className="w-full bg-error/10 border border-error/50 text-error hover:bg-error hover:text-on-error font-body-base text-body-sm font-semibold py-2.5 rounded transition-all">
