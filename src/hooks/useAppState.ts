      ...
      return {
        ...
        logs: [
          ...state.logs,
          {
            ...
            roomName: "Sistem Geneli",
            type: "system",
            title: "ACİL DURUM GİDERİLDİ",
            details: note ? `Operatör tarafından güvenli duruma dönüldü. Not: ${note}` : "Operatör tarafından güvenli duruma dönüldü.",
          },
        ],
      };
    }
...
export function useAppState() {
  ...
  // Use a ref to avoid recreating the interval every second
  ...
  }, []); // Empty deps - single stable interval
